<div class="h-[50rem] lg:flex lg:flex-row overflow-y-auto">
    ...
    {{-- Right Side --}}
    <div class="lg:w-4/12 flex flex-col bg-white dark:bg-neutral-900 p-5">
      ...
      <textarea placeholder="{{ __('Write description...') }}" wire:model="description"
                class="ring-none border-none h-64 w-full mb-2 rounded dark:bg-neutral-700 dark:text-gray-100"></textarea>
            @error('description')
